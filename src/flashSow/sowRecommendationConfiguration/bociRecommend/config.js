...
// 查询接口
export const searchApiUrl = '/sys/sortingConfig/pageReBatchSortingRecData'

// 新增
export function addConfig(data) {
  return $http({
    url: '/sys/sortingConfig/newReBatchSortingRecConfig',
    method: 'post',
    data
  })
}
...
export function updateConfig(data) {
  return $http({
    url: '/sys/sortingConfig/updReBatchSortingRecConfig',
    method: 'post',
    data
  })
}
