...
export default function App(props) {
  ...
  return <div className='sowRecommendationConfiguration'>
    <Page
      // 自定义查询 自定表头 code
      code="sow_recommendation_configuration_other"
    // 查询配置
      searchOptions={{
        url: searchApiUrl,
        method: 'post',
      ...
      // 工具栏配置
      tools={[
        {type: 'formDialog', config: formModeConfig, title: '新增', DialogWidth: 750, refresh: true,
          data: {
            warehouseId: getWid(),
            isNeedScan: '1',
          },
      ...
      operationsWidth={130}
      operations={[
        {type: 'formDialog', config: formModeConfig, title: '修改', refresh: true, DialogWidth: 750,
