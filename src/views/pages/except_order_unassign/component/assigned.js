...
import {searchModel, columns} from '../config/assigned'
...
export default function App(props) {
    ...
    function beforeSearch(req) {
        const time = getRangTime(req.data, {
                    time: 'assignTaskTime',
                    start: 'assignTaskTimeStart',
                    end: 'assignTaskTimeEnd'
                })
        return {
            ...req,
    ...
    defineSearchCode="task_order_exception_assigned"
    tableOptions={{
        url: '/pcsweb/task/order/exception/assigned',
        method: 'post',
    }}
  >
  </QueryList>
