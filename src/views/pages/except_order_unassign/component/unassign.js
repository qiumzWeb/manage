...
export default function App(props) {
    ...
    function fenPei() {
      ...
      $http({
          url: `/task/order/exception/employeeList?warehouseId=${currentSearchData.warehouseId}&exceptionType=` + selectedRows[0]['exceptionType'],
          method: 'get',
          oldApi: true
      }).then(function(res){
          if (res.code === '0') {
    ...
    return <div>
      ...
      defineSearchCode="task_order_exception_unAssign"
      tableOptions={{
          url: '/pcsweb/task/order/exception/unAssign',
          method: 'post',
          attrs: {
            rowSelection: {
                onChange: (keys, rows) => {
